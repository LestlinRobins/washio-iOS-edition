  ...
  return (
    <div className="main-div-in-floor">
      <header className="ground-page-header">
        ...
        <div className="ground-page-header-app-name">Terrace Slot Booking</div>
      ...
      {tomorrow ? (
        <div className="tab-switcher">
          <div className="tab-switcher-tab" onClick={() => setTomorrow(false)}>
            Today
          </div>
        ...
        <div className="tab-switcher">
          ...
          <div className="tab-switcher-tab" onClick={() => setTomorrow(true)}>
            Tomorrow
          </div>
        </div>
      )}
                ...
                >
                  ...
                  >
                    ...
                    <div className="data-div">
                      ...
                      <div className="room-no-div">NHA-{row.RoomNo}</div>
                    </div>
                  </TableCell>
                  <TableCell
                    sx={{
                  ...
                  {row.Status == "Active" && (
                    <TableCell
                      sx={{ color: "#04a302", fontFamily: "Jetbrains-R" }}
                      align="left"
                    >
                      ⬤
                    </TableCell>
                  ...
                  {row.Status == "Finished" && (
                    <TableCell
                      sx={{ color: "#505050", fontFamily: "Jetbrains-R" }}
                      align="left"
                    >
                      ⬤
                    </TableCell>
                  ...
                  {row.Status == "Pending" && (
                    <TableCell
                      sx={{ color: "red", fontFamily: "Jetbrains-R" }}
                      align="left"
                    >
                      ⬤
                    </TableCell>
      ...
      <div className="floating-button">
        <Link to={tomorrow ? "/BookingThreeTomorrow" : "/BookingThree"}>
          <Fab
            sx={{
              borderRadius: 40,
              width: 50,
